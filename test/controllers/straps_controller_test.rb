...
class StrapsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create strap" do
    assert_difference('Strap.count') do
      post straps_url, params: { strap: { guitar_id: @strap.guitar_id, in_stock_quantity: @strap.in_stock_quantity, size: @strap.size, user_id: @strap.user_id } }
    end
  ...
  test "should update strap" do
    patch strap_url(@strap), params: { strap: { guitar_id: @strap.guitar_id, in_stock_quantity: @strap.in_stock_quantity, size: @strap.size, user_id: @strap.user_id } }
